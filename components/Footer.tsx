      ...
      <div className="container-shell grid gap-10 py-14 md:grid-cols-[1.2fr_0.8fr_0.8fr_1.1fr]">
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-sm text-white/65">
            <Link href="/indoor"  className="transition hover:text-white">Indoor Plants + Pots</Link>
            <Link href="/outdoor" className="transition hover:text-white">Outdoor Plants + Pots</Link>
            <Link href="/pots"    className="transition hover:text-white">Pots Only</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-sm text-white/65">
            ...
            <Link href="/care-guide" className="transition hover:text-white">Care Guide</Link>
