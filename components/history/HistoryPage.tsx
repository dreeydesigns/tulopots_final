...
export function HistoryPage({ content }: HistoryPageProps) {
  ...
  return (
    <main className="tp-page overflow-x-hidden pb-24 pt-24 lg:pt-28">
      <section className="container-shell lg:flex lg:min-h-[84svh] lg:items-center">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 xl:grid-cols-[0.92fr_1.08fr] xl:items-end xl:gap-16">
            ...
            <div className="overflow-hidden rounded-[2.4rem] border border-[var(--tp-border)] bg-[var(--tp-card)]">
              <div className="relative aspect-[4/4.9] overflow-hidden sm:aspect-[5/4.8] xl:aspect-[4/4.7] xl:min-h-[36rem]">
                <Image
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  <div className="max-w-xl rounded-[1.65rem] border border-white/18 bg-[rgba(20,12,8,0.52)] px-6 py-5 backdrop-blur-md">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[rgba(247,242,234,0.72)]">
                      The Line
                    </div>
                    <div className="mt-4 serif-display text-2xl leading-[1.1] text-[var(--tp-cream)] md:text-[2.2rem]">
                      {content.quote}
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-14 flex justify-center md:mt-20 xl:mt-24">
            <div className="max-w-4xl text-center">
              ...
              <p className="mx-auto mt-5 max-w-3xl serif-display text-3xl leading-[1.18] tp-heading md:text-4xl lg:text-[3rem]">
      ...
      <section className="container-shell mt-16 space-y-20 md:mt-24 md:space-y-24 xl:space-y-28">
        {chapters.map((chapter, index) => {
          ...
          return (
            <article
              ...
              className="grid gap-8 lg:min-h-[80svh] lg:grid-cols-12 lg:items-center lg:gap-10 xl:gap-14"
            >
              <div className={`lg:col-span-5 ${reverse ? 'lg:order-2' : ''}`}>
                <div className="lg:sticky lg:top-28">
                  ...
                  >
                    <div className="relative aspect-[5/5.4] overflow-hidden md:aspect-[5/4.4] lg:aspect-[4/4.8]">
                      <Image
              ...
              <div className={`lg:col-span-7 ${reverse ? 'lg:order-1' : ''}`}>
                ...
                >
                  ...
                  <div className="relative rounded-[2.2rem] border bg-[var(--tp-card)] px-7 py-7 md:px-8 md:py-9 xl:px-10 xl:py-10">
                    <div
                    ...
                    <h2 className="mt-5 max-w-3xl serif-display text-4xl leading-[1.05] tp-heading md:text-5xl xl:text-[3.2rem]">
                      {chapter.title}
                    </h2>

                    <p className="mt-7 max-w-3xl text-base leading-8 tp-text-soft md:text-lg md:leading-8">
                      {chapter.body}
                    </p>

                    <div
                      className="mt-8 max-w-3xl border-l-2 pl-6 text-lg leading-8 tp-heading md:text-xl"
      ...
      <section className="container-shell mt-20 md:mt-24 lg:flex lg:min-h-[76svh] lg:items-center">
        <div className="w-full rounded-[2.5rem] border border-[var(--tp-border)] bg-[var(--tp-card)] px-7 py-8 md:px-9 md:py-10 xl:px-10 xl:py-12">
          <div className="max-w-3xl">
            <div className="text-xs font-semibold uppercase tracking-[0.22em] tp-accent">
              {content.galleryEyebrow}
            </div>
            <h2 className="mt-5 serif-display text-4xl leading-[1.05] tp-heading md:text-5xl xl:text-[3rem]">
              {content.galleryTitle}
            </h2>
            <p className="mt-5 max-w-2xl text-base leading-8 tp-text-soft md:leading-8">
            ...
            {galleryImages.map((item) => (
              ...
              >
                ...
                <div className="px-6 py-5">
                  <h3 className="serif-display text-[2rem] leading-[1.06] tp-heading">
                    {item.title}
                  </h3>
                  <p className="mt-3 text-sm leading-8 tp-text-soft">{item.caption}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="container-shell mt-20 md:mt-24 lg:flex lg:min-h-[76svh] lg:items-center">
        <div className="w-full rounded-[2.6rem] border border-[var(--tp-border)] bg-[var(--tp-card)] px-7 py-10 text-center md:px-10 md:py-12 xl:px-12 xl:py-14">
          <div className="text-xs font-semibold uppercase tracking-[0.22em] tp-accent">
            {content.closingEyebrow}
          </div>
          <h2 className="mx-auto mt-5 max-w-4xl serif-display text-4xl leading-[1.05] tp-heading md:text-5xl xl:text-[3.2rem]">
            {content.closingTitle}
          </h2>
          <p className="mx-auto mt-7 max-w-2xl text-base leading-8 tp-text-soft md:text-lg md:leading-8">
            {content.closingBody}
          </p>
